...
{
public:
	UDriver(void);		//constructor
	~UDriver(void);		//destructor
...
private:
	...
	std::wstring driverName;		//driver name
	std::wstring driverPath;		//driver disk path
	std::wstring driverDosName;	//driver's dos name, to link with it
